uhepresswerk)
    ...
    appCustomVersion(){ /usr/bin/defaults read "/Library/Application Support/u-he/Presswerk/Engine/Presswerk.engine/Contents/Info.plist" CFBundleVersion 2>/dev/null }
